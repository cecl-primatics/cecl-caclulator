...
import com.primatics.ignite.model.Loan;

public class AnalysisEntryProcessor implements CacheEntryProcessor<Integer, Loan, Loan> {
	...
	public AnalysisEntryProcessor(final Double[] survivalScalingFactor, final Double[] lossRateScalingFactor) {
